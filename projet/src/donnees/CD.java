...
public class CD {
     ...
     *
     * @param artiste    nom de l'artiste qui a fait le C
     * @param nomCDParam titre du CD
     */
     ...
     *
     * @param infoPiste les informations concernant la piste (duree et titre)
     */
     ...
     */ public String toString() {
        String r = SEPARATOR;
        r += this.nomArtiste + " - " + this.nomCD + " (" + pistes.size() + " pistes)\n";
        // ajoute les pistes
    ...
    private String numeroPiste(int i) {
        ...
        if (numPiste < 10) resultat = "0" + resultat;
        return (resultat);
    }

    public int comparer(CD autre) {
